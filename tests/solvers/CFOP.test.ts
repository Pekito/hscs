...
import { parseNotationSequenceToMoveSequence } from "../../src/cube/Notation";
...
describe("getUnsolvedF2LTable", () => {
    it("Should return free slots", () => {
        const freeSlots = createCubeState(parseNotationSequenceToMoveSequence("R U R' L' U L L U' L' R' U R"));
    ...
    it("Should return no free slots", () => {
        const freeSlots = createCubeState(parseNotationSequenceToMoveSequence("R U R'"));
    ...
    it("Should return FL blocked", () => {
        const freeSlots = createCubeState(parseNotationSequenceToMoveSequence("R U R' R' U R L U L'"));
    ...
    it("Should return BL blocked", () => {
        const freeSlots = createCubeState(parseNotationSequenceToMoveSequence("R U R' L' U L R' U R"));
    ...
    it("Should return BR blocked", () => {
        const freeSlots = createCubeState(parseNotationSequenceToMoveSequence("R U R' L' U L L U L'"));
    ...
    it("Should return FL BL blocked", () => {
        const freeSlots = createCubeState(parseNotationSequenceToMoveSequence("R U R' R' U R"));
    ...
    it("Should return FL BR blocked", () => {
        const freeSlots = createCubeState(parseNotationSequenceToMoveSequence("R U R' L U L'"));
