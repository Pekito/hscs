...
class Cube {
  ...
  /**
   * Target indexes that should be permuted to represent a "U move". The difference to the solved state is the actual permutation indexes.
   */
  U_Move: Array<number> = [
  ...
  /**
   * Target indexes that should be permuted to represent a "R move". The difference to the solved state is the actual permutation indexes.
   */
  R_Move: Array<number> = [
  ...
  /**
   * Target indexes that should be permuted to represent a "F move". The difference to the solved state is the actual permutation indexes.
   */
  F_Move: Array<number> = [
  ...
  /**
   * Target indexes that should be permuted to represent a "D move". The difference to the solved state is the actual permutation indexes.
   */
  D_Move: Array<number> = [
  ...
  /**
   * Target indexes that should be permuted to represent a "L move". The difference to the solved state is the actual permutation indexes.
   */
  L_Move: Array<number> = [
  ...
  /**
   * Target indexes that should be permuted to represent a "B move". The difference to the solved state is the actual permutation indexes.
   */
  B_Move: Array<number> = [
